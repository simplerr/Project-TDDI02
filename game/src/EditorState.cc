	...
	if ( e.type == SDL_MOUSEBUTTONDOWN  )
	{
		...
		for (unsigned int i{}; i < buttonList.size(); ++i)
		{
			if( buttonList[i]->mouseOver(mousePos)) //om innanför en knapp
			{
				...
				case 2: currentObject = new Powerup(mousePos, 38, 38, FILEPATH_POWERUP1); break;
				...
				case 6: currentObject = new Platform( mousePos, 104, 104, FILEPATH_PLATFORM_4 ); break;
				case 7: currentObject = new Platform( mousePos, 104, 104, FILEPATH_PLATFORM_5 ); break;
				case 8: currentObject = new Platform( mousePos, 104, 104, FILEPATH_PLATFORM_6 ); break;
				case 9: currentObject = new Background( mousePos, 200, 200, FILEPATH_BACKGROUND_1 ); break;
				case 10: currentObject = new Background( mousePos, 200, 200, FILEPATH_BACKGROUND_2 ); break;
				case 11: currentObject = new Decoration( mousePos, 200, 200, "../imgs/downloads/Other/Grass.png" ); break;
				case 12:
